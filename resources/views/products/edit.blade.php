                ...
                <div class="p-6">
                    <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->title }}" class="object-cover w-32 h-32 rounded-lg">
                        </div>
                            ...
                            <div class="flex justify-center px-6 pt-5 pb-6 mt-1 transition border-2 border-gray-300 border-dashed rounded-lg dark:border-gray-600 hover:border-indigo-500">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                        <label for="image" class="relative font-medium text-indigo-600 bg-white rounded-md cursor-pointer dark:bg-gray-800 dark:text-indigo-400 hover:text-indigo-500">
