    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-12 sm:px-6 lg:px-8">
        <div class="w-full max-w-md">
            <div class="mb-8 text-center">
                ...
                <h2 class="mt-6 text-3xl font-bold text-white">Selamat Datang</h2>
                <p class="mt-2 text-sm text-gray-400">Login ke akun anda untuk melanjutkan ke Dashboard</p>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username"
                                ...
                                placeholder="apanapin@gmail.com">
                        </div>
                        @error('email')
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center">
                            <input type="checkbox" name="remember" class="text-indigo-600 bg-gray-700 border-gray-600 rounded shadow-sm focus:ring-indigo-500">
                    ...
                    <div class="text-center">
                        <span class="text-sm text-gray-400">Tidak punya akun ?</span>
                        <a href="{{ route('register') }}" class="ml-1 text-sm font-medium text-indigo-400 transition hover:text-indigo-300">
                            Daftar
                        </a>
                    </div>
                </form>
